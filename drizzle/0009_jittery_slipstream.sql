...
CREATE INDEX `idx_files_chapter` ON `files` (`chapter_id`);--> statement-breakpoint
CREATE INDEX `idx_files_submission` ON `files` (`submission_id`);--> statement-breakpoint
CREATE INDEX `idx_files_notice` ON `files` (`notice_id`);